...
class Update10(models.TransientModel):
    ...
    server_old = fields.Char(
        "Server Old", help="Server Old", default="190.114.253.252"
    )
    ...
    server_new = fields.Char(
        "This Server", help="Server Old", default="190.114.253.252"
    )
    ...
    val_materials = fields.Boolean(
        "Import materials", help="Import materials", default=True
    )
